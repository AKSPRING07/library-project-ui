...
const roleConfigs: RoleDashboardConfig[] = [
  {
    ...
    menus: [
      ...
      { title: "AI Book Search", url: "/student/ai-book-search", icon: Search },
      { title: "Browse Books", url: "/student/browse-books", icon: BookOpen },
      { title: "Borrowed Books", url: "/student/borrowed-books", icon: BookMarked },
      { title: "Reservations", url: "/student/reservations", icon: CalendarClock },
      { title: "Reading Progress", url: "/student/reading-progress", icon: TrendingUp },
      { title: "AI Recommendations", url: "/student/ai-recommendations", icon: Sparkles },
      { title: "Fines & Due Dates", url: "/student/fines-due-dates", icon: Receipt },
      { title: "Digital Library Card", url: "/student/digital-library-card", icon: CreditCard },
      { title: "Notifications", url: "/student/notifications", icon: Bell },
      { title: "Profile", url: "/student/profile", icon: UserRound },
      { title: "Settings", url: "/student/settings", icon: Settings },
    ],
    quickLinks: [
      { name: "Borrow Scanner", url: "/student/borrowed-books", icon: QrCode },
      { name: "Shelf Map", url: "/student/browse-books", icon: MapPinned },
      { name: "AI Assistant", url: "/student/ai-recommendations", icon: Bot },
    ],
    metrics: [
  ...
  },
  {
    ...
    menus: [
      { title: "Dashboard", url: "/staff", icon: BriefcaseBusiness },
      { title: "AI Book Search", url: "/staff/ai-book-search", icon: Search },
      { title: "Browse Books", url: "/staff/browse-books", icon: BookOpen },
      { title: "Borrowed Books", url: "/staff/borrowed-books", icon: BookMarked },
      { title: "Research Materials", url: "/staff/research-materials", icon: BookAudio },
      { title: "External Book Requests", url: "/staff/external-book-requests", icon: FileSearch },
      { title: "Academic Requirements", url: "/staff/academic-requirements", icon: ClipboardCheck },
      { title: "Department Analytics", url: "/staff/department-analytics", icon: Building2 },
      { title: "AI Recommendations", url: "/staff/ai-recommendations", icon: Sparkles },
      { title: "Request Status", url: "/staff/request-status", icon: TicketCheck },
      { title: "Notifications", url: "/staff/notifications", icon: Bell },
      { title: "Profile", url: "/staff/profile", icon: UserRound },
      { title: "Settings", url: "/staff/settings", icon: Settings },
    ],
    quickLinks: [
      { name: "New Request", url: "/staff/external-book-requests", icon: FileSearch },
      { name: "Dept Analytics", url: "/staff/department-analytics", icon: ChartColumn },
      { name: "Approvals", url: "/staff/request-status", icon: BadgeCheck },
    ],
    metrics: [
  ...
  },
  {
    ...
    menus: [
      { title: "Dashboard", url: "/librarian", icon: LibraryBig },
      { title: "Manage Books", url: "/librarian/manage-books", icon: BookCopy },
      { title: "Add/Edit Books", url: "/librarian/add-edit-books", icon: BookOpen },
      { title: "Borrow & Return", url: "/librarian/borrow-return", icon: ArrowRightLeft },
      { title: "User Management", url: "/librarian/user-management", icon: Users },
      { title: "Reservations", url: "/librarian/reservations", icon: CalendarClock },
      { title: "Fine Collection", url: "/librarian/fine-collection", icon: Receipt },
      { title: "Inventory Analytics", url: "/librarian/inventory-analytics", icon: ChartColumn },
      { title: "AI Reports", url: "/librarian/ai-reports", icon: BrainCircuit },
      { title: "RFID Tracking", url: "/librarian/rfid-tracking", icon: RadioTower },
      { title: "QR Monitoring", url: "/librarian/qr-monitoring", icon: QrCode },
      { title: "Face Recognition", url: "/librarian/face-recognition", icon: ScanFace },
      { title: "Robot Monitoring", url: "/librarian/robot-monitoring", icon: Bot },
      { title: "Complaints", url: "/librarian/complaints", icon: MessageSquareWarning },
      { title: "Attendance Monitoring", url: "/librarian/attendance-monitoring", icon: Fingerprint },
      { title: "Notifications", url: "/librarian/notifications", icon: Bell },
      { title: "Settings", url: "/librarian/settings", icon: Settings },
    ],
    quickLinks: [
      { name: "Add Book", url: "/librarian/add-edit-books", icon: BookOpen },
      { name: "AI Report", url: "/librarian/ai-reports", icon: BrainCircuit },
      { name: "Complaints", url: "/librarian/complaints", icon: MessageSquareWarning },
    ],
    metrics: [
  ...
  },
  {
    ...
    menus: [
      { title: "Dashboard", url: "/technician", icon: Wrench },
      { title: "Complaints", url: "/technician/complaints", icon: MessageSquareWarning },
      { title: "RFID Monitoring", url: "/technician/rfid-monitoring", icon: RadioTower },
      { title: "Face Recognition Systems", url: "/technician/face-recognition-systems", icon: ScanFace },
      { title: "Robot Monitoring", url: "/technician/robot-monitoring", icon: Bot },
      { title: "Device Connectivity", url: "/technician/device-connectivity", icon: Wifi },
      { title: "Server Health", url: "/technician/server-health", icon: Server },
      { title: "Camera Monitoring", url: "/technician/camera-monitoring", icon: Camera },
      { title: "Maintenance Schedule", url: "/technician/maintenance-schedule", icon: CalendarClock },
      { title: "System Logs", url: "/technician/system-logs", icon: HardDrive },
      { title: "Alerts", url: "/technician/alerts", icon: ShieldAlert },
      { title: "Notifications", url: "/technician/notifications", icon: Bell },
      { title: "Settings", url: "/technician/settings", icon: Settings },
    ],
    quickLinks: [
      { name: "Open Tickets", url: "/technician/complaints", icon: TicketCheck },
      { name: "Server Health", url: "/technician/server-health", icon: Server },
      { name: "Robot Fleet", url: "/technician/robot-monitoring", icon: Bot },
    ],
    metrics: [
